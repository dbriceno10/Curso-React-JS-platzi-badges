...
class BadgeEdit extends React.Component {
  ...
  fetchData = async (e) => {
    ...
    try {
      const data = await api.badges.read(this.props.match.params.badgeId); //read va a tomar el id del badge que nos interesa, usando los props, cada una de esas variables que insertamos en el path que declaramos en la ruta lo podemos acceder dentro del objeto params
  ...
  handleSubmit = async (e) => {
    ...
    try {
      await api.badges.update(this.props.match.params.badgeId, this.state.form); //El handleSubmit ya no es de crear (create), es de actualizar (update),que recibe el id y la información que queremos actualizar
