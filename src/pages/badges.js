...
class Badges extends React.Component {
  // state = {
  //   //ahora vamos a traer los datos desde la api, se inicializan como undefinded
  //   loading: true,
  //   error: null,
  //   data: undefined,
  // };
  ...
  // constructor(props) {
  //   //El constructor recibe props, el cual necesitamos para inicializar la SuperClase
  //   super(props);
  ...
  //   console.log({
  //     prevProps: propsPrevios,
  //     PrevState: estadoPrevio,
  //   });
  ...
  render() {
    if (this.state.loading === true && !this.state.data) {
      //Pide los datos de forma automática, la primera vez
      return <PageLoading />;
    }
